...
struct AuthConstants {
    ...
    struct SignInView {
        ...
        static let usernameAccessibilityId: String = "username".getAccessibilityIdentifier(type: .accPlainTextField)
        ...
        static let usernameSeparatorLineAccessibilityId = "username".getAccessibilityIdentifier(type: .accSeparatorLine)
        ...
        static let passwordAccessibilityId: String = "password".getAccessibilityIdentifier(type: .accSecureTextField)
        ...
        static let passwordSeparatorLineAccessibilityId = "password".getAccessibilityIdentifier(type: .accSeparatorLine)
        ...
        static let submitTitleAccessibilityId: String = "sign-in".getAccessibilityIdentifier(type: .accButtonTitle)
        ...
        static let signUpButtonAccessibilityId: String = "sign-up".getAccessibilityIdentifier(type: .accButton)
        ...
        static let forgotPasswordButtonAccessibilityId: String = "forgot-password".getAccessibilityIdentifier(type: .accButton)
        ...
        static let errorAlertAccessibilityId: String = "error".getAccessibilityIdentifier(type: .accAlert)
        static let errorAlertTitle: LocalizedStringKey = "lang-sign-in-view-error-alert-title-key"
        static let errorAlertButtonTitle: LocalizedStringKey = "lang-sign-in-view-error-alert-button-title-key"
        static let errorAlertMessage: LocalizedStringKey = "lang-sign-in-view-error-alert-message-key"

        static let circularButtonTitle: String = "Sign In"
        static let signInButtonAccessibilityId: String = "sign-in".getAccessibilityIdentifier(type: .accButton)
